...
namespace SchoolProject.Web.Controllers
{
    public class GenresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Id,IdGuid,WasDeleted,CreatedAt,UpdatedAt")] Genre genre)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Id,IdGuid,WasDeleted,CreatedAt,UpdatedAt")] Genre genre)
        {
            if (id != genre.Id)
            {
                return NotFound();
