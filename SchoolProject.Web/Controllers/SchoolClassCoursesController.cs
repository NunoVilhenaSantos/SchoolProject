...
namespace SchoolProject.Web.Controllers
{
    public class SchoolClassCoursesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,IdGuid,WasDeleted,CreatedAt,UpdatedAt")] SchoolClassCourse schoolClassCourse)
        {
            if (id != schoolClassCourse.IdGuid)
            {
                return NotFound();
            }
        ...
        {
          return (_context.SchoolClassCourses?.Any(e => e.IdGuid == id)).GetValueOrDefault();
        }
    }
}
