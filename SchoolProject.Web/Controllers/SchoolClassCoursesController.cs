...
namespace SchoolProject.Web.Controllers
{
    public class SchoolClassCoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SchoolClassId,CourseId,CreatedById,UpdatedById,Id,IdGuid,WasDeleted,CreatedAt,UpdatedAt")] SchoolClassCourse schoolClassCourse)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SchoolClassId,CourseId,CreatedById,UpdatedById,Id,IdGuid,WasDeleted,CreatedAt,UpdatedAt")] SchoolClassCourse schoolClassCourse)
        {
