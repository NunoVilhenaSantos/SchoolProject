...
namespace SchoolProject.Web.Controllers
{
    public class SchoolClassCoursesController : Controller
    {
        ...
        {
            var dataContextMySql = _context.SchoolClassCourses.Include(s => s.Course).Include(s => s.CreatedBy).Include(s => s.SchoolClass).Include(s => s.UpdatedBy);
        ...
        public async Task<IActionResult> Create([Bind("SchoolClassId,CourseId,Id,IdGuid,WasDeleted,CreatedAt,CreatedById,UpdatedAt,UpdatedById")] SchoolClassCourse schoolClassCourse)
        {
            ...
            ViewData["CourseId"] = new SelectList(_context.Courses, "Id", "Code", schoolClassCourse.CourseId);
            ViewData["CreatedById"] = new SelectList(_context.Users, "Id", "Id", schoolClassCourse.CreatedById);
            ViewData["SchoolClassId"] = new SelectList(_context.SchoolClasses, "Id", "Acronym", schoolClassCourse.SchoolClassId);
            ViewData["UpdatedById"] = new SelectList(_context.Users, "Id", "Id", schoolClassCourse.UpdatedById);
            return View(schoolClassCourse);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SchoolClassId,CourseId,Id,IdGuid,WasDeleted,CreatedAt,CreatedById,UpdatedAt,UpdatedById")] SchoolClassCourse schoolClassCourse)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DataContextMySql.SchoolClassCourses'  is null.");
            }
            var schoolClassCourse = await _context.SchoolClassCourses.FindAsync(id);
            if (schoolClassCourse != null)
            {
        ...
        {
          return (_context.SchoolClassCourses?.Any(e => e.SchoolClassId == id)).GetValueOrDefault();
        }
    }
}
