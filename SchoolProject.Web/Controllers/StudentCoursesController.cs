    ...
    public class StudentCoursesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.StudentCourses != null ? 
                          ...
                          Problem("Entity set 'DataContextMsSql.StudentCourses'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,IdGuid,WasDeleted,CreatedAt,UpdatedAt")] StudentCourse studentCourse)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdGuid,WasDeleted,CreatedAt,UpdatedAt")] StudentCourse studentCourse)
        {
