...
namespace SchoolProject.Web.Controllers
{
    public class TeacherCoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TeacherId,CourseId,Id,IdGuid,WasDeleted,CreatedAt,CreatedById,UpdatedAt,UpdatedById")] TeacherCourse teacherCourse)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TeacherId,CourseId,Id,IdGuid,WasDeleted,CreatedAt,CreatedById,UpdatedAt,UpdatedById")] TeacherCourse teacherCourse)
        {
