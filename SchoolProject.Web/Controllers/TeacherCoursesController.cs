...
namespace SchoolProject.Web.Controllers
{
    public class TeacherCoursesController : Controller
    {
        ...
        {
            var dataContextMsSql = _context.TeacherCourses.Include(t => t.Course).Include(t => t.Teacher);
        ...
        public async Task<IActionResult> Create([Bind("TeacherId,CourseId,Id,IdGuid,WasDeleted,CreatedAt,UpdatedAt")] TeacherCourse teacherCourse)
        {
            ...
            ViewData["CourseId"] = new SelectList(_context.Courses, "Id", "Name", teacherCourse.CourseId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("TeacherId,CourseId,Id,IdGuid,WasDeleted,CreatedAt,UpdatedAt")] TeacherCourse teacherCourse)
        {
            if (id != teacherCourse.IdGuid)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            ...
            {
                return Problem("Entity set 'DataContextMsSql.TeacherCourses'  is null.");
            }
            var teacherCourse = await _context.TeacherCourses.FindAsync(id);
            if (teacherCourse != null)
            {
        ...
        {
          return (_context.TeacherCourses?.Any(e => e.IdGuid == id)).GetValueOrDefault();
        }
    }
}
