    ...
    public class TeacherCoursesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.TeacherCourses != null ? 
                          ...
                          Problem("Entity set 'DataContextMsSql.TeacherCourses'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,IdGuid,WasDeleted,CreatedAt,UpdatedAt")] TeacherCourse teacherCourse)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdGuid,WasDeleted,CreatedAt,UpdatedAt")] TeacherCourse teacherCourse)
        {
        ...
        {
          return (_context.TeacherCourses?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
