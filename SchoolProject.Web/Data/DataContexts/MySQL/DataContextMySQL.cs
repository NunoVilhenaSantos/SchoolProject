...
/// <inheritdoc />
public class DataContextMySql : IdentityDbContext<AppUser, IdentityRole, string>
{
    /// <inheritdoc />
    ...
    /// <inheritdoc />
    public DataContextMySql(DbContextOptions<DcMySqlOnline> options) :
        base(options)
    {
    }
    ...
    /// <inheritdoc />
    public DataContextMySql(DbContextOptions<DcMySqlLocal> options) :
        base(options)
    {
    }
