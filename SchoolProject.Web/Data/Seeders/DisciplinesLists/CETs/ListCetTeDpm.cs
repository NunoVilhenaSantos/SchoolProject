...
public record ListCetTeDpm
{
    internal static readonly Dictionary<string, (string, int, double)>
        TeDpmDictionary = new()
        {
            ...
            {
                "5396",
                ("Desenho e administração de bases de dados", 50, 4.50)
            },
            ...
            {
                "0146",
                ("Imagem/vídeo - captação, registo e edição", 50, 4.50)
            },
            {"5404", ("Pós-produção de vídeo", 50, 4.50)},
            {
                "5405",
                ("Metodologia e gestão de projetos multimédia", 50, 4.50)
            },
