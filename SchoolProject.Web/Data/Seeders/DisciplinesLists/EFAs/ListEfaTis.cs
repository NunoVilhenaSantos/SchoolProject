namespace SchoolProject.Web.Data.Seeders.DisciplinesLists.EFAs;

public abstract record ListEfaTis
{
    internal static readonly Dictionary<string, (string, int, double)>
        TisDictionary = new()
        {
            ...
            {
                "0774",
                ("Rede local - instalação de software base", 50, 4.50)
            },
            ...
            {
                "0783",
                ("Programação em C/C++ - ciclos e decisões", 50, 4.50)
            },
            {
                "0784",
                ("Programação em C/C++ - funções e estruturas", 50, 4.50)
            },
            ...
            {
                "10791",
                ("Desenvolvimento de aplicações web em JAVA", 50, 4.50)
            },
            {"0791", ("Programação em JAVA - avançada", 50, 4.50)},
            {
                "0792",
                ("Criação de páginas para a web em hipertexto", 25, 2.25)
            },
