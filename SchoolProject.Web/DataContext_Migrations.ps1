...
dotnet ef migrations script       --context DataContextMySQL   --output C:\repos\SchoolProject\SQL\migration_script_MySQL.sql
...
dotnet ef migrations script       --context DataContextSqLite  --output C:\repos\SchoolProject\SQL\migration_script_SQLite.sql
...
dotnet ef migrations script       --context DataContextMsSql   --output C:\repos\SchoolProject\SQL\migration_script_MsSql.sql
