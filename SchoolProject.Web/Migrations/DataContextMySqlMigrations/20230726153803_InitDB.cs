    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
                ...
                table => new
                {
                    ...
                    Name = table.Column<string>("varchar(20)", maxLength: 20,
                        nullable: false),
                    GenreId = table.Column<Guid>("char(36)", nullable: false),
                    WasDeleted =
                        table.Column<bool>("tinyint(1)", nullable: false),
                    CreatedAt =
        ...
        migrationBuilder.CreateTable(
                ...
                table => new
                {
                    ...
                    ProfilePhotoId =
                        table.Column<Guid>("char(36)", nullable: false),
                    CourseId = table.Column<Guid>("char(36)", nullable: false),
                    WasDeleted =
                        table.Column<bool>("tinyint(1)", nullable: false),
                    CreatedAt =
                        table.Column<DateTime>("datetime(6)", nullable: false),
        ...
        migrationBuilder.CreateTable(
                ...
                table => new
                {
                    ...
                    StudentId = table.Column<Guid>("char(36)", nullable: false),
                    WasDeleted =
                        table.Column<bool>("tinyint(1)", nullable: false),
                    CreatedAt =
                        table.Column<DateTime>("datetime(6)", nullable: false),
        ...
        migrationBuilder.CreateTable(
                ...
                table => new
                {
                    ...
                    ProfilePhotoId =
                        table.Column<Guid>("char(36)", nullable: false),
                    TeacherId = table.Column<Guid>("char(36)", nullable: false),
                    WasDeleted =
                        table.Column<bool>("tinyint(1)", nullable: false),
                    CreatedAt =
                        table.Column<DateTime>("datetime(6)", nullable: false),
