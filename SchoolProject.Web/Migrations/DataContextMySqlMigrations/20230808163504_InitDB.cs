    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "varchar(256)", maxLength: 256,
                        nullable: true),
                    NormalizedName = table.Column<string>(type: "varchar(256)",
        ...
        migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfilePhotoId =
                        table.Column<Guid>(type: "char(36)", nullable: false),
                    WasDeleted =
                        table.Column<bool>(type: "tinyint(1)", nullable: false),
                    UserName = table.Column<string>(type: "varchar(256)",
                        maxLength: 256, nullable: true),
                    NormalizedUserName = table.Column<string>(type: "varchar(256)",
                        maxLength: 256, nullable: true),
                    Email = table.Column<string>(type: "varchar(256)", maxLength: 256,
                        nullable: true),
                    NormalizedEmail = table.Column<string>(type: "varchar(256)",
                        maxLength: 256, nullable: true),
                    EmailConfirmed =
                        table.Column<bool>(type: "tinyint(1)", nullable: false),
                    PasswordHash =
        ...
        migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation(name: "MySQL:ValueGenerationStrategy",
                            value: MySQLValueGenerationStrategy.IdentityColumn),
                    RoleId =
                        table.Column<string>(type: "varchar(255)", nullable: false),
                    ClaimType =
                        table.Column<string>(type: "longtext", nullable: true),
                    ClaimValue =
                        table.Column<string>(type: "longtext", nullable: true)
        ...
        migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation(name: "MySQL:ValueGenerationStrategy",
                            value: MySQLValueGenerationStrategy.IdentityColumn),
                    Name = table.Column<string>(type: "varchar(20)", maxLength: 20,
                        nullable: false),
                    ProfilePhotoId =
                        table.Column<Guid>(type: "char(36)", nullable: true),
                    IdGuid = table.Column<Guid>(type: "char(36)", nullable: false,
                    ...
                    CreatedById =
                        table.Column<string>(type: "varchar(255)", nullable: false),
                    UpdatedAt =
                        table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    UpdatedById =
                        table.Column<string>(type: "varchar(255)", nullable: true)
                },
                constraints: table =>
                {
        ...
        migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation(name: "MySQL:ValueGenerationStrategy",
                            value: MySQLValueGenerationStrategy.IdentityColumn),
                    Name = table.Column<string>(type: "varchar(50)", maxLength: 50,
                        nullable: false),
                    IdGuid = table.Column<Guid>(type: "char(36)", nullable: false,
                        defaultValueSql: "(UUID())"),
                    WasDeleted =
        ...
        migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation(name: "MySQL:ValueGenerationStrategy",
                            value: MySQLValueGenerationStrategy.IdentityColumn),
                    Code = table.Column<string>(type: "varchar(7)", maxLength: 7,
                        nullable: false),
                    ...
                    EqfLevel = table.Column<byte>(type: "tinyint unsigned",
                        nullable: false),
                    StartDate =
                        table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    EndDate =
                        table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    StartHour =
                        table.Column<TimeSpan>(type: "time(6)", nullable: false),
                    EndHour =
                        table.Column<TimeSpan>(type: "time(6)", nullable: false),
                    Location = table.Column<string>(type: "longtext", nullable: true),
                    Type = table.Column<string>(type: "longtext", nullable: true),
                    Area = table.Column<string>(type: "longtext", nullable: true),
                    PriceForEmployed = table.Column<decimal>(type: "decimal(10,2)",
                        precision: 10, scale: 2, nullable: false),
                    PriceForUnemployed = table.Column<decimal>(type: "decimal(10,2)",
                        precision: 10, scale: 2, nullable: false),
                    ProfilePhotoId =
                        table.Column<Guid>(type: "char(36)", nullable: true),
                    IdGuid = table.Column<Guid>(type: "char(36)", nullable: false,
        ...
        migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreditPoints =
                        table.Column<double>(type: "double", nullable: false),
                    ProfilePhotoId =
                        table.Column<Guid>(type: "char(36)", nullable: false),
                    IdGuid = table.Column<Guid>(type: "char(36)", nullable: false,
                        defaultValueSql: "(UUID())"),
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation(name: "MySQL:ValueGenerationStrategy",
                            value: MySQLValueGenerationStrategy.IdentityColumn),
                    FirstName =
                        table.Column<string>(type: "longtext", nullable: false),
                    LastName =
                        table.Column<string>(type: "longtext", nullable: false),
