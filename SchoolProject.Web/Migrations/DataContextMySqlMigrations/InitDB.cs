...
public partial class InitDB : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
                ...
                table => new
                {
                    Id = table.Column<string>("varchar(255)",
                        nullable: false),
                    Name = table.Column<string>("varchar(256)",
                        maxLength: 256, nullable: true),
                    NormalizedName = table.Column<string>(
                        "varchar(256)", maxLength: 256,
                        nullable: true),
                    ConcurrencyStamp =
                        table.Column<string>("longtext",
                            nullable: true)
                },
                constraints: table =>
                {
        ...
        migrationBuilder.CreateTable(
                ...
                table => new
                {
                    ...
                    ProfilePhotoId = table.Column<Guid>("char(36)",
                        nullable: false),
                    WasDeleted = table.Column<bool>("tinyint(1)",
                        nullable: false),
                    UserName = table.Column<string>("varchar(256)",
                        maxLength: 256, nullable: true),
                    NormalizedUserName =
                        table.Column<string>("varchar(256)",
                            maxLength: 256, nullable: true),
                    Email = table.Column<string>("varchar(256)",
                        maxLength: 256, nullable: true),
                    NormalizedEmail = table.Column<string>(
                        "varchar(256)", maxLength: 256,
                        nullable: true),
                    EmailConfirmed = table.Column<bool>("tinyint(1)",
                        nullable: false),
                    PasswordHash = table.Column<string>("longtext",
                        nullable: true),
                    SecurityStamp = table.Column<string>("longtext",
                        nullable: true),
                    ConcurrencyStamp =
                        table.Column<string>("longtext",
                            nullable: true),
                    PhoneNumber = table.Column<string>("longtext",
                        nullable: true),
                    PhoneNumberConfirmed =
                        table.Column<bool>("tinyint(1)",
                            nullable: false),
                    TwoFactorEnabled =
                        table.Column<bool>("tinyint(1)",
                            nullable: false),
                    LockoutEnd =
                        table.Column<DateTimeOffset>("datetime(6)",
                            nullable: true),
                    LockoutEnabled = table.Column<bool>("tinyint(1)",
                        nullable: false),
                    AccessFailedCount =
        ...
        migrationBuilder.CreateTable(
                ...
                table => new
                {
                    ...
                    RoleId = table.Column<string>("varchar(255)",
                        nullable: false),
                    ClaimType = table.Column<string>("longtext",
                        nullable: true),
                    ClaimValue = table.Column<string>("longtext",
                        nullable: true)
                },
                constraints: table =>
                {
        ...
        migrationBuilder.CreateTable(
                ...
                table => new
                {
                    Id = table.Column<int>("int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy",
                            MySQLValueGenerationStrategy.IdentityColumn),
                    UserId = table.Column<string>("varchar(255)",
                        nullable: false),
                    ClaimType = table.Column<string>("longtext",
                        nullable: true),
                    ClaimValue = table.Column<string>("longtext",
        ...
        migrationBuilder.CreateTable(
                ...
                {
                    LoginProvider =
                        table.Column<string>("varchar(255)",
                            nullable: false),
                    ProviderKey = table.Column<string>("varchar(255)",
                        nullable: false),
                    ProviderDisplayName =
                        table.Column<string>("longtext",
                            nullable: true),
        ...
        migrationBuilder.CreateTable(
                ...
                table => new
                {
                    ...
                    Name = table.Column<string>("varchar(255)",
                        nullable: false),
                    Value = table.Column<string>("longtext",
                        nullable: true)
                },
                constraints: table =>
                {
        ...
        migrationBuilder.CreateTable(
                ...
                table => new
                {
                    Id = table.Column<int>("int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy",
                            MySQLValueGenerationStrategy.IdentityColumn),
                    Name = table.Column<string>("varchar(20)",
                        maxLength: 20, nullable: false),
                    ProfilePhotoId = table.Column<Guid>("char(36)",
                        nullable: true),
                    IdGuid = table.Column<Guid>("char(36)",
                    ...
                    CreatedAt = table.Column<DateTime>("datetime(6)",
                        ...
                        .Annotation("MySQL:ValueGenerationStrategy",
                            MySQLValueGenerationStrategy.IdentityColumn),
                    CreatedById = table.Column<string>("varchar(255)",
                        nullable: true),
                    UpdatedAt = table.Column<DateTime>("datetime(6)",
                        nullable: true),
                    UpdatedById = table.Column<string>("varchar(255)",
                        nullable: true)
                },
                constraints: table =>
                {
        ...
        migrationBuilder.CreateTable(
                ...
                table => new
                {
                    Id = table.Column<int>("int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy",
                            MySQLValueGenerationStrategy.IdentityColumn),
                    Name = table.Column<string>("varchar(50)",
                        maxLength: 50, nullable: false),
                    IdGuid = table.Column<Guid>("char(36)",
                        nullable: false, defaultValueSql: "(UUID())"),
                    WasDeleted = table.Column<bool>("tinyint(1)",
        ...
        migrationBuilder.CreateTable(
                ...
                table => new
                {
                    Id = table.Column<int>("int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy",
                            MySQLValueGenerationStrategy.IdentityColumn),
                    Code = table.Column<string>("varchar(7)",
                        maxLength: 7, nullable: false),
                    Acronym = table.Column<string>("longtext",
                        nullable: false),
                    Name = table.Column<string>("longtext",
                        nullable: false),
                    QnqLevel = table.Column<byte>("tinyint unsigned",
                        nullable: false),
                    EqfLevel = table.Column<byte>("tinyint unsigned",
                        nullable: false),
                    StartDate = table.Column<DateTime>("datetime(6)",
                        nullable: false),
                    EndDate = table.Column<DateTime>("datetime(6)",
                        nullable: false),
                    StartHour = table.Column<TimeSpan>("time(6)",
                        nullable: false),
                    EndHour = table.Column<TimeSpan>("time(6)",
                        nullable: false),
                    Location = table.Column<string>("longtext",
                        nullable: true),
                    Type = table.Column<string>("longtext",
                        nullable: true),
                    Area = table.Column<string>("longtext",
                        nullable: true),
                    PriceForEmployed =
                        table.Column<decimal>("decimal(10,2)",
        ...
        migrationBuilder.CreateTable(
                ...
                table => new
                {
                    ...
                    CreditPoints = table.Column<double>("double",
                        nullable: false),
                    ProfilePhotoId = table.Column<Guid>("char(36)",
                        nullable: false),
                    IdGuid = table.Column<Guid>("char(36)",
                    ...
                    UpdatedById = table.Column<string>("varchar(255)",
                        nullable: true),
                    SchoolClassId =
                        table.Column<int>("int", nullable: true)
                },
                constraints: table =>
                {
        ...
        migrationBuilder.CreateTable(
                ...
                table => new
                {
                    Id = table.Column<int>("int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy",
                            MySQLValueGenerationStrategy.IdentityColumn),
                    FirstName = table.Column<string>("longtext",
                        nullable: false),
                    LastName = table.Column<string>("longtext",
                        nullable: false),
                    Address = table.Column<string>("longtext",
                        nullable: false),
                    PostalCode = table.Column<string>("longtext",
                        nullable: false),
                    CityId =
                        table.Column<int>("int", nullable: false),
                    CountryId =
                        table.Column<int>("int", nullable: false),
                    MobilePhone = table.Column<string>("longtext",
                        nullable: false),
                    Email = table.Column<string>("longtext",
                        nullable: false),
                    Active = table.Column<bool>("tinyint(1)",
                        nullable: false),
                    GenderId =
                        table.Column<int>("int", nullable: false),
                    DateOfBirth =
                        table.Column<DateTime>("datetime(6)",
                            nullable: false),
                    ...
                    BirthplaceId =
                        table.Column<int>("int", nullable: false),
                    EnrollDate = table.Column<DateTime>("datetime(6)",
                        nullable: false),
                    UserId = table.Column<string>("varchar(255)",
                        nullable: false),
                    ProfilePhotoId = table.Column<Guid>("char(36)",
