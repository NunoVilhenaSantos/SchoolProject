    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                ...
                Name = table.Column<string>("TEXT", maxLength: 20,
                    nullable: false),
                GenreId = table.Column<Guid>("TEXT", nullable: false),
                WasDeleted = table.Column<bool>("INTEGER", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                Id = table.Column<int>("INTEGER", nullable: false)
                    .Annotation("Sqlite:Autoincrement", true),
                ClassAcronym = table.Column<string>("TEXT", nullable: false),
                ...
                SchoolClassId = table.Column<Guid>("TEXT", nullable: false),
                WasDeleted = table.Column<bool>("INTEGER", nullable: false),
                CreatedAt = table.Column<DateTime>("TEXT", nullable: false),
                CreatedById = table.Column<string>("TEXT", nullable: true),
                UpdatedAt = table.Column<DateTime>("TEXT", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                Id = table.Column<int>("INTEGER", nullable: false)
                    .Annotation("Sqlite:Autoincrement", true),
                Name = table.Column<string>("TEXT", nullable: false),
                WorkLoad = table.Column<int>("INTEGER", nullable: false),
                Credits = table.Column<int>("INTEGER", nullable: false),
                ProfilePhotoId = table.Column<Guid>("TEXT", nullable: false),
                CourseId = table.Column<Guid>("TEXT", nullable: false),
                WasDeleted = table.Column<bool>("INTEGER", nullable: false),
                CreatedAt = table.Column<DateTime>("TEXT", nullable: false),
                CreatedById = table.Column<string>("TEXT", nullable: true),
                UpdatedAt = table.Column<DateTime>("TEXT", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_SchoolClassCourses", x => x.IdGuid);
                table.ForeignKey(
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                ...
                UserId = table.Column<string>("TEXT", nullable: false),
                ProfilePhotoId = table.Column<Guid>("TEXT", nullable: false),
                CoursesCount = table.Column<int>("INTEGER", nullable: false),
                TotalWorkHours = table.Column<int>("INTEGER", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                ...
                UserId = table.Column<string>("TEXT", nullable: false),
                ProfilePhotoId = table.Column<Guid>("TEXT", nullable: false),
                TeacherId = table.Column<Guid>("TEXT", nullable: false),
                WasDeleted = table.Column<bool>("INTEGER", nullable: false),
                CreatedAt = table.Column<DateTime>("TEXT", nullable: false),
                CreatedById = table.Column<string>("TEXT", nullable: true),
                UpdatedAt = table.Column<DateTime>("TEXT", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                ...
                Grade = table.Column<decimal>("TEXT", precision: 18, scale: 2,
                    nullable: true),
                EnrollmentId = table.Column<Guid>("TEXT", nullable: false),
                WasDeleted = table.Column<bool>("INTEGER", nullable: false),
                CreatedAt = table.Column<DateTime>("TEXT", nullable: false),
                CreatedById = table.Column<string>("TEXT", nullable: true),
                UpdatedAt = table.Column<DateTime>("TEXT", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                StudentCourseId = table.Column<Guid>("TEXT", nullable: false),
                StudentId = table.Column<int>("INTEGER", nullable: false),
                CourseId = table.Column<int>("INTEGER", nullable: false),
                Id = table.Column<int>("INTEGER", nullable: false),
                WasDeleted = table.Column<bool>("INTEGER", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                TeacherCourseId = table.Column<Guid>("TEXT", nullable: false),
