    ...
    public partial class InitDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "TEXT", nullable: false),
                    FirstName = table.Column<string>(type: "TEXT",
                    ...
                    Address = table.Column<string>(type: "TEXT", maxLength: 100,
                        nullable: true),
                    ProfilePhotoId =
                        table.Column<Guid>(type: "TEXT", nullable: false),
                    WasDeleted =
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "TEXT", maxLength: 20,
                        nullable: false),
                    ProfilePhotoId =
                        table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "TEXT", nullable: false),
                    QnqLevel =
                        table.Column<byte>(type: "INTEGER", nullable: false),
                    EqfLevel =
                        table.Column<byte>(type: "INTEGER", nullable: false),
                    StartDate =
                        table.Column<DateTime>(type: "TEXT", nullable: false),
                    ...
                    PriceForEmployed = table.Column<decimal>(type: "TEXT",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreditPoints =
                        table.Column<double>(type: "REAL", nullable: false),
                    ProfilePhotoId =
                        table.Column<Guid>(type: "TEXT", nullable: false),
                    IdGuid = table.Column<Guid>(type: "TEXT", nullable: false,
                        defaultValueSql: "NEWID()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseId =
                        table.Column<int>(type: "INTEGER", nullable: false),
                    Grade = table.Column<decimal>(type: "TEXT", precision: 18,
