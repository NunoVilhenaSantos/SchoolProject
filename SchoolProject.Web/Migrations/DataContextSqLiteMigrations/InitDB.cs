...
public partial class InitDB : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                ...
                Name = table.Column<string>("TEXT", maxLength: 256,
                    nullable: true),
                NormalizedName = table.Column<string>("TEXT",
        ...
        migrationBuilder.CreateTable(
            ...
            {
                Id = table.Column<string>("TEXT", nullable: false),
                FirstName = table.Column<string>("TEXT",
                ...
                Address = table.Column<string>("TEXT", maxLength: 100,
                    nullable: true),
                ProfilePhotoId =
                    table.Column<Guid>("TEXT", nullable: false),
                WasDeleted =
                ...
                Email = table.Column<string>("TEXT", maxLength: 256,
                    nullable: true),
                NormalizedEmail = table.Column<string>("TEXT",
                    maxLength: 256, nullable: true),
                EmailConfirmed =
                    table.Column<bool>("INTEGER", nullable: false),
                PasswordHash =
                ...
                TwoFactorEnabled =
                    table.Column<bool>("INTEGER", nullable: false),
                LockoutEnd =
                    table.Column<DateTimeOffset>("TEXT",
                        nullable: true),
                LockoutEnabled =
                    table.Column<bool>("INTEGER", nullable: false),
                AccessFailedCount =
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                ...
                Name = table.Column<string>("TEXT", maxLength: 20,
                    nullable: false),
                ProfilePhotoId =
                    table.Column<Guid>("TEXT", nullable: true),
                ...
                CreatedById =
                    table.Column<string>("TEXT", nullable: true),
                UpdatedAt =
                    table.Column<DateTime>("TEXT", nullable: true),
                UpdatedById =
                    table.Column<string>("TEXT", nullable: true)
            },
            constraints: table =>
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                ...
                Name = table.Column<string>("TEXT", nullable: false),
                QnqLevel =
                    table.Column<byte>("INTEGER", nullable: false),
                EqfLevel =
                    table.Column<byte>("INTEGER", nullable: false),
                StartDate =
                    table.Column<DateTime>("TEXT", nullable: false),
                EndDate =
                    table.Column<DateTime>("TEXT", nullable: false),
                StartHour =
                    table.Column<TimeSpan>("TEXT", nullable: false),
                EndHour =
                    table.Column<TimeSpan>("TEXT", nullable: false),
                Location =
                    table.Column<string>("TEXT", nullable: true),
                ...
                PriceForEmployed = table.Column<decimal>("TEXT",
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                ...
                CreditPoints =
                    table.Column<double>("REAL", nullable: false),
                ProfilePhotoId =
                    table.Column<Guid>("TEXT", nullable: false),
                IdGuid = table.Column<Guid>("TEXT", nullable: false,
                    defaultValueSql: "NEWID()"),
                ...
                UpdatedById =
                    table.Column<string>("TEXT", nullable: true),
                SchoolClassId =
                    table.Column<int>("INTEGER", nullable: true)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                ...
                CourseId =
                    table.Column<int>("INTEGER", nullable: false),
                Grade = table.Column<decimal>("TEXT", precision: 18,
