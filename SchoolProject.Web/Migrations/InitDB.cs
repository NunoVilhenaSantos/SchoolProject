...
public partial class InitDB : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SchoolClassStudents",
                        x => new {x.SchoolClassId, x.StudentId});
                    table.ForeignKey(
                        "FK_SchoolClassStudents_AspNetUsers_CreatedById",
                        x => x.CreatedById,
                        "AspNetUsers",
                        "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        "FK_SchoolClassStudents_AspNetUsers_UpdatedById",
                        x => x.UpdatedById,
                        "AspNetUsers",
                        "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        "FK_SchoolClassStudents_SchoolClasses_SchoolClassId",
                        x => x.SchoolClassId,
                        "SchoolClasses",
                        "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        "FK_SchoolClassStudents_Students_StudentId",
                        x => x.StudentId,
                        "Students",
                        "Id",
                        onDelete: ReferentialAction.Restrict);
        ...
        migrationBuilder.CreateIndex(
            "IX_SchoolClassStudents_CreatedById",
            "SchoolClassStudents",
            "CreatedById");

        migrationBuilder.CreateIndex(
            "IX_SchoolClassStudents_StudentId",
            "SchoolClassStudents",
            "StudentId");

        migrationBuilder.CreateIndex(
            "IX_SchoolClassStudents_UpdatedById",
            "SchoolClassStudents",
            "UpdatedById");
