...
(
    "Id"             INTEGER NOT NULL
        CONSTRAINT "PK_Countries" PRIMARY KEY AUTOINCREMENT,
    "Name"           TEXT    NOT NULL,
    "ProfilePhotoId" TEXT    NOT NULL,
...
(
    "Id"             INTEGER NOT NULL
        CONSTRAINT "PK_Genders" PRIMARY KEY AUTOINCREMENT,
    "Name"           TEXT    NOT NULL,
    "IdGuid"         TEXT    NOT NULL DEFAULT (NEWID()),
    "WasDeleted"     INTEGER NOT NULL,
    "CreatedAt"      TEXT    NOT NULL,
...
(
    "Id"                 INTEGER NOT NULL
        CONSTRAINT "PK_SchoolClasses" PRIMARY KEY AUTOINCREMENT,
    "Code"               TEXT    NOT NULL,
...
(
    "Id"             INTEGER NOT NULL
        CONSTRAINT "PK_Cities" PRIMARY KEY AUTOINCREMENT,
    "Name"           TEXT    NOT NULL,
    "IdGuid"         TEXT    NOT NULL DEFAULT (NEWID()),
    "WasDeleted"     INTEGER NOT NULL,
    "CreatedAt"      TEXT    NOT NULL,
...
(
    "Id"          INTEGER NOT NULL
        CONSTRAINT "PK_Nationalities" PRIMARY KEY AUTOINCREMENT,
    "Name"        TEXT    NOT NULL,
    "IdGuid"      TEXT    NOT NULL DEFAULT (NEWID()),
    "WasDeleted"  INTEGER NOT NULL,
    "CreatedAt"   TEXT    NOT NULL,
...
(
    "Id"                                 INTEGER NOT NULL
        CONSTRAINT "PK_Students" PRIMARY KEY AUTOINCREMENT,
    "FirstName"                          TEXT    NOT NULL,
    "LastName"                           TEXT    NOT NULL,
...
(
    "Id"                                 INTEGER NOT NULL
        CONSTRAINT "PK_Teachers" PRIMARY KEY AUTOINCREMENT,
    "FirstName"                          TEXT    NOT NULL,
    "LastName"                           TEXT    NOT NULL,
    "Address"                            TEXT    NOT NULL,
    "PostalCode"                         TEXT    NOT NULL,
...
(
    "Id"            INTEGER NOT NULL
        CONSTRAINT "PK_SchoolClassStudent" PRIMARY KEY AUTOINCREMENT,
    "SchoolClassId" INTEGER NOT NULL,
    "StudentId"     INTEGER NOT NULL,
    "IdGuid"        TEXT    NOT NULL DEFAULT (NEWID()),
    "WasDeleted"    INTEGER NOT NULL,
...
VALUES ('20230831112150_InitDB', '7.0.10');
